function varargout = readAudio(varargin)
...
% Last Modified by GUIDE v2.5 16-Apr-2018 03:57:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @readAudio_OpeningFcn, ...
                   'gui_OutputFcn',  @readAudio_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function readAudio_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = readAudio_OutputFcn(hObject, eventdata, handles) 
...
%MODULACIÓN
[Y1,q]=MPSK1(8,Y,1);
[Y2,P,SNR]=Canal(Y1,1,q,5,1,200,20,20,0.5);
w=DEMPSK1(Y2,q,8,1);
